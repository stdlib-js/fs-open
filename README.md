...
```javascript
import open from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-open@v0.2.3-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-open@v0.2.3-esm/index.mjs';
```
